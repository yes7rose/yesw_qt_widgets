...
# -----------------
#  Authur: 闫刚
#　Create date: '2017/11/7' '15:29'
# -----------------

from qtpy import QtWidgets

class BrowsFileNameWidget(QtWidgets.QWidget):
    """
    """
    def __init__(self, open_location = "\.",file_filter = "*.*",parent=None):
        super(BrowsFileNameWidget, self).__init__()
    ...
    def browseFile(self):
        """
        """
        file_name = QtWidgets.QFileDialog.getOpenFileName(self, 'browse file', self._open_location, self._file_filter, '')[0]
        if not file_name:
            return
